...
#file to read in
infile = '/Users/suneetsingh/Desktop/Boxplot/l2/l2_latency_boxplot.csv'
infile = '/home/lion/workspace/macsad_latency/eps_figures/Boxplot/l2/l2_latency_boxplot.csv'
...
#plt.xticks([0,64, 128])
plt.xticks(np.arange(44), ('', '64', '128', '256', '512','1024','1280','1518','','','64', '128', '256', '512','1024','1280','1518', '','','64', '128', '256', '512','1024','1280','1518','','','64', '128', '256', '512','1024','1280','1518','','','64', '128', '256', '512','1024','1280','1518'))

bp.grid(color='g', linestyle='--')
bp.grid(axis='x')
#df.legend([bp["boxes"][0]], ['A'], loc='upper right')
#plt.legend()
plt.show()
