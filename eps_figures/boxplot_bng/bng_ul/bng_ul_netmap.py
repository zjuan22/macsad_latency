...
infile = '/home/lion/workspace/macsad_latency/eps_figures/boxplot_bng/bng_ul/bng_ul_latency_netmap.csv'
...
plt.title('BNG_UL Use case with Netmap Pktio')
...
#bp.grid(axis='x')
plt.text(0, 4700, '          1                100              1k                10k              100k ')

plt.text(15, 2800, u' Number of entries',fontsize=11)
