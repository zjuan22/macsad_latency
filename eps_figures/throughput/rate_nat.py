...
ul_100k=[1.57,3.16,6.29,9.62,9.81,9.88,9.88]
dl_100k=[1.72,3.24,6.35,9.74,9.80,9.80,9.80]

ul_10k=[1.63,3.32,6.40,9.62,9.81,9.81,9.81]
dl_10k=[1.79,3.56,6.67,9.72,9.80,9.80,9.80]

ul_100=[2.10,3.62,6.56,9.62,9.81,9.85,9.86]
dl_100=[2.07,3.68,6.63,9.60,9.80,9.80,9.80]

ul_1k=[1.94,3.51,6.35,9.64,9.81,9.81,9.81]
dl_1k=[1.98,3.69,6.56,9.68,9.80,9.80,9.80]
...
numb = [0,64,128,256,512,1024,1280,1528,0,0,98,128,256,512,1024,1280,1528]
...
pos_y= -2
ax.text(8, pos_y, u'NAT_UL',fontsize=font_size)
ax.text(23.5, pos_y, u'NAT_DL',fontsize=font_size)
...
filename="rate_diff_table_e_nat"
