...
infile = '/home/lion/workspace/macsad_latency/eps_figures/results_11_09_2018/bng_up_latency_dpdk_netmap2.csv'
...
#plt.xticks([0,64, 128])
plt.xticks(np.arange(42), ('','', '98','1518','','','98','1518', '','','98','1518','','','98','1518','','','98','1518','','','','98','1518','','','98','1518','','','98','1518','','','98','1518','','','98','1518'))

#bp.grid(color='g', linestyle='--')
#bp.grid(axis='x')
plt.text(0, -2500, '      8       32      128     512     1024        8      32      128     512     1024')

plt.text(16, -4200, u'   Burst size',fontsize=12)
plt.text(8, -5200, u'   DPDK                                     Netmap',fontsize=12)
